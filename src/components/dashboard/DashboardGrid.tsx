...
const defaultButtons: DashboardButton[] = [
  ...
  },
  {
    ...
    description: "Comprehensive Class Type Performance Analysis",
    icon: <Zap size={28} />,
    color: "text-violet-700",
    gradient: "from-violet-50 to-pink-100",
    hoverColor: "hover:border-violet-300",
    bgGradient: "from-violet-600 to-pink-600"
  }
];
        ...
        {buttons.map((button) => (
          <button
            ...
            className={cn(
              ...
              hoveredButton === button.id && "border-slate-300 shadow-lg"
            )}
          ...
          >
            ...
            <div 
              className={cn(
                ...
                hoveredButton === button.id && "opacity-50"
              )}
            />
            ...
            <div className="relative z-10 space-y-5">
              ...
              <div className={cn(
                ...
                button.color,
                hoveredButton === button.id && "shadow-md scale-105",
