          ...
          <Table>
            <TableHeader className="sticky top-0 z-20">
              <TableRow className="bg-gradient-to-r from-blue-50 to-purple-50 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 h-[25px]">
                <TableHead className="cursor-pointer hover:bg-blue-100 transition-colors font-bold text-gray-700 sticky left-0 bg-gradient-to-r from-blue-50 to-purple-50 z-30 min-w-[250px] w-[250px] max-w-[250px] h-[25px] p-2" onClick={() => handleSort('source')}>
            ...
            <TableBody>
              {filteredSources.map((source, sourceIndex) => <TableRow key={source} className="hover:bg-blue-50/50 transition-colors cursor-pointer h-[25px]" onClick={() => handleRowClick(source)}>
