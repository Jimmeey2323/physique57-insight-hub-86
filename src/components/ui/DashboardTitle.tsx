...
import { BarChart3, TrendingUp, Activity, DollarSign, Percent, Scale } from 'lucide-react';
...
const DashboardTitle = () => {
  ...
  const colors = ['text-blue-400', 'text-purple-400', 'text-pink-400', 'text-indigo-400', 'text-cyan-400', 'text-emerald-400'];
  useEffect(() => {
  ...
  return <div className="flex items-center justify-center p-1 my-0 px-0 py-px">
      <motion.div variants={containerVariants} initial="hidden" animate="visible" className="text-center max-w-6xl mx-auto">
        ...
        <div className="relative">
          ...
          <motion.div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10 blur-3xl" animate={{
          opacity: [0.3, 0.6, 0.3],
          scale: [0.8, 1.1, 0.8]
        }} transition={{
          duration: 4,
          ...
          {/* Border under title */}
          <motion.div variants={itemVariants} className="w-48 h-px bg-gradient-to-r from-transparent via-border to-transparent mx-auto mt-2 mb-4" />

          {/* Subtitle */}
          <motion.div variants={itemVariants} className="flex items-center justify-center gap-3 mb-6">
            <motion.div variants={iconVariants} className="p-2 rounded-full bg-muted border border-border">
        ...
        <motion.div variants={itemVariants} className="flex justify-center items-center gap-2 mt-8">
          ...
          <div className="w-2 h-2 rounded-full bg-purple-400 animate-pulse" style={{
          animationDelay: '0.5s'
        }} />
          <div className="w-2 h-2 rounded-full bg-pink-400 animate-pulse" style={{
          animationDelay: '1s'
        }} />
        </motion.div>

        {/* Bottom border */}
        <motion.div variants={itemVariants} className="w-24 h-px bg-gradient-to-r from-transparent via-border to-transparent mx-auto mt-6" />
      </motion.div>
    </div>;
};
