        ...
        <div className="container mx-auto px-6 py-8">
          ...
          <header className="mb-8 text-center">
            <div className="inline-flex items-center justify-center mb-4">
              <div className="bg-gradient-to-r from-slate-800 to-slate-900 text-white px-8 py-2 rounded-full text-sm font-medium shadow-lg tracking-wide">
                Business Intelligence Dashboard
              </div>
            </div>
            
            <h1 className="text-4xl md:text-5xl font-light text-slate-900 mb-2 tracking-tight font-serif">
              <span className="font-extralight">Physique</span>{' '}
              <span className="font-bold animate-color-cycle text-6xl">57</span>
              <span className="text-slate-600 font-light">, India</span>
            </h1>
            
            <p className="text-lg text-slate-600 font-light mb-6 max-w-3xl mx-auto leading-relaxed">
          ...
          <main className="max-w-7xl mx-auto">
            <div className={`${designTokens.card.background} backdrop-blur-sm rounded-3xl p-8 ${designTokens.card.shadow} border border-slate-200/30`}>
