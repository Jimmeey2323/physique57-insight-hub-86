...
const TrainerPerformance = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50/30 to-pink-50/20">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-teal-600 via-cyan-600 to-blue-700 text-white">
        <div className="absolute inset-0 bg-black/20" />
        
        {/* Animated background elements */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-4 -left-4 w-32 h-32 bg-white/10 rounded-full animate-pulse"></div>
          <div className="absolute top-20 right-10 w-24 h-24 bg-teal-300/20 rounded-full animate-bounce delay-1000"></div>
          <div className="absolute bottom-10 left-20 w-40 h-40 bg-cyan-300/10 rounded-full animate-pulse delay-500"></div>
        </div>
        ...
        <div className="relative px-8 py-12">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center space-y-4">
              ...
              <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-white via-teal-100 to-cyan-100 bg-clip-text text-transparent animate-fade-in-up delay-200">
